...
% Adresse des ports COM des 3 monochromateurs
% A ajuster
Adresse_TriVistaEtage1 = 3;
Adresse_TriVistaEtage2 = 4;
Adresse_TriVistaEtage3 = 5;
...
case {'?G/MM', '?BLAZE'}
    ...
    k = strfind(a,char(10));
    param = strrep(a(k(i)+1:k(i+1)-1),'  ',' ');% ligne caractérisant le système
    switch upper(fonction)
        case '?G/MM'
            j=strfind(param,' ');
