...
%   CONFIG_INITIALE
%               Configure l'appareil pour les mesures
%   MESURE_COMPTEUR
%               Lit le nombre de comptes a l'entree du compteur
...
% if isempty(RACALDANA)
%     RACALDANA = initialise(3); %l'addresse par defaut est 3
% end
...
%     case 'FERMER'
%         fclose(RACALDANA1991);
%         delete(RACALDANA1991);
%         clear RACALDANA1991;
%         %         RACALDANA1991 = [];
    case {'INITIALISE'}
        global spectrapro275
        ...
        %RacalDana(''); %l'addresse par defaut est 3
...
function INSTRUMENT = initialise(addresse)
    ...
    global spectrapro275_OFFSET
    switch upper(sp275GPIB)
        case 'TRIVISTA' %initialise_SR400(addresse)
