...
??? compléter avec http://www.picoquant.com/products/category/tcspc-and-time-tagging-modules/hydraharp-400-multichannel-picosecond-event-timer-tcspc-module
...
Il est important de ne pas dépasser 1.5 Volt en entrée sur les entrées.
...
Ils ont les caractéristiques suivantes: 50 $\mu$m, cooled, timing, Grade C.

Les détecteurs doivent être alimentés pour fonctionner.
...
Dans l'état actuel, il ne permet pas d'accéder aux modes avancés (T2 et T3).
