...
\usepackage[pdftex,
            pdfauthor={Colin-N. Brosseau},
            pdftitle={Procédurier Laboratoire Richard Leonelli},
            pdfsubject={},
            pdfkeywords={Physique, Spectroscopie, Optique},
            pdfproducer={},
            pdfcreator={}]{hyperref}
...
\noindent Copyright \copyright\ 2017 Colin-N. Brosseau\\ % Copyright notice
\noindent \textit{Version \input{version}}\\ % Edition

%\noindent \textsc{Published by Publisher}\\ % Publisher

\noindent Sources de ce document, codes informatiques et documents\\
\noindent \textsc{\url{https://github.com/ColinBrosseau/LaboratoireLeonelli}}\\ % URL

\noindent Fichier PDF\\
\noindent \textsc{\url{https://github.com/ColinBrosseau/Documents/raw/master/procedurierLeonelli.pdf}}\\
...
\input{entretien-periodique.tex}
...
%% \subsubsection{Contrôle par Python}

%%     Préparation de l'interface WinSpec-Python

%% \input{preparation_interface_WinView_Python.tex}
...
\input{utilisation_de_Synkron.tex}
...
\begin{table}[htbp]
  ...
  \end{tabular}
%  \caption{Procédure d'alignement du Matisse}
...
\section{Mira}\index{Mira (Ti:Saphire)}
...
\section{Modulateurs Acousto-Optique}\index{Modulateurs Acousto-Optique}
...
\begin{figure}[h!tbp]
  \centering\includegraphics[width=.5\linewidth]{modulateursAcoustoOptique1}
  \caption{Modulateurs Acousto-Optique}
  \label{fig:modulateursAcoustoOptique1}
\end{figure}

\begin{figure}[htbp]
  \centering\includegraphics[width=.5\linewidth]{modulateursAcoustoOptique2}
  \caption{Modulateurs Acousto-Optique}
  \label{fig:modulateursAcoustoOptique2}
\end{figure}

\begin{figure}[htbp]
  \centering\includegraphics[width=.5\linewidth]{modulateursAcoustoOptique3}
  \caption{Modulateurs Acousto-Optique}
  \label{fig:modulateursAcoustoOptique3}
\end{figure}

\begin{figure}[htbp]
  \centering\includegraphics[width=.5\linewidth]{modulateursAcoustoOptique4}
  \caption{Modulateurs Acousto-Optique}
  \label{fig:modulateursAcoustoOptique4}
\end{figure}

\begin{figure}[htbp]
  \centering\includegraphics[width=.5\linewidth]{modulateursAcoustoOptique5}
  \caption{Modulateurs Acousto-Optique}
...
\begin{figure}[htbp]
\centering\includegraphics[width=.75\linewidth]{trivista-slit.png}
...
\section{U1000}\index{U1000}

Lorsqu'on utilise la CCD, l'énergie minimale accessible dépend de la largeur des fentes intermédiaires.
Voir la figure \ref{fig:u1000-energie-minimale-raman}.

\begin{figure}[htbp]
    \centering
    \def\svgwidth{.75\columnwidth}
    \input{Images/U1000-energie-minimale-fentes-intermediaires.pdf_tex}
...
# def measureRange(self, Range , nOverlap=3, accTime=1, images=False, unit='cm-1', maskCCD=None, plot=True, spectroSlits=10, detector='CCD', rootFilename='.', baseFilename=None, sample='', comment=''):
#        """
...
# images: 5 repetitions par position (a partir de 5, un algorithme enleve efficacement les pics du aux "rayons cosmiques"
# nOverlap: Chaque position est mesuree a 4 endroits differents sur la CCD (pour enlever le flatfield). Autrement dit, chaque mesure successive se deplace de 1/4 de la plage totale de la CCD, donc chaque position est mesuree 4 fois.
# mesure en cm-1 relatif
x,y = m.measureRange([150, 550], unit='cm-1', accTime=10, images=5, nOverlap=4)
...
# mesure en Angstroem
# Ici la plage est un nombre seul (5461). Ce sera la position centrale de la CCD.
x,y = m.measureRange(5461, accTime=1, images=10, unit='A')
#
# mesure entre 6500 et 6700 A
# mesure en Angstroem
x,y = m.measureRange([6500, 6700], unit='A'), accTime=1, images=10, nOverlap=5)
\end{lstlisting}
