...
(??? à confirmer auprès de Richard) Seul le détecteur silicium prend en compte le {\it Gain Pos}.

Si de fortes oscillations se produisent dans l'interférogramme (??? confirmer avec Guillaume) il faut mettre {\it Gain Pos} à {\it None}. 
